...
function Modal({ open, onClose, children, title }) {
  ...
  return (
    open && (
      <div className="backdrop-blur-sm fixed top-0 left-0 w-full h-screen bg-secondary-700 bg-opacity-30 z-50">
        <div
          ref={ref}
        ...
        >
          <div className="flex items-center justify-between border-b border-b-secondary-300 pb-2 mb-5">
